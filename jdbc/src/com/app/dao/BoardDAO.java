...
//  게시글 추가
	public void insert(BoardVO boardVO) {
		...
		try {
			...
			System.out.println("insert(BoardVO) SQL 입력 오류");
			e.printStackTrace();
		} catch (Exception e) {
				e.printStackTrace();
		} finally {
...
//  게시글 1개 조회
	public BoardDTO selectBoard(Long boardId) {
		...
		try {
			...
			System.out.println("selectBoard(Long) SQL 입력 오류");
			e.printStackTrace();
		} catch (Exception e) {
				e.printStackTrace();
		} finally {
...
//  게시글 목록
	public List<BoardDTO> selectAll(Long boardId){
		...
		try {
			...
			System.out.println("selectAll(Long) SQL 입력 오류");
			e.printStackTrace();
		} catch (Exception e) {
				e.printStackTrace();
		} finally {
...
//  게시글 삭제
	public void delete(Long boardId) {
		...
		try {
			...
			System.out.println("delete(Long) SQL 입력 오류");
			e.printStackTrace();
		} catch (Exception e) {
				e.printStackTrace();
		} finally {
